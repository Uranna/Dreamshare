...
form.addEventListener('submit', (e)=>{
    ...
    if (formData.get('interests').length == 0) addValidateInput();
    else {
...
form.querySelector('.send-info__input').addEventListener('click', ()=>{
    if (form.querySelector('.send-info__input').classList.contains('send-info__input--error')) removeValidateInput();
});
document.querySelector('.send-info__bg').addEventListener('click', removeValidateInput);

},{"./main.scss":"hdE12"}],"hdE12":[function() {},{}]},["lBB98","hD4hw"], "hD4hw", "parcelRequireb7aa")
